...
class EigenFacesRecognizer(FaceRecognizer):
    """It recognizes faces on video using Eigen face recognition algorithm"""

    def __init__(self, face_dir, casc_path):
        """RecognizeFisherFaces constructor"""
        super(EigenFacesRecognizer, self).__init__(face_dir, casc_path)
    ...
    def load_trained_data(self, training_data):
        ...
        super(EigenFacesRecognizer, self).load_trained_data(training_data)
